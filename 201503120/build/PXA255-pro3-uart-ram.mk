...
# for Windows
	...
	if exist ..\obj\*.axf del ..\obj\*.axf
	if exist ..\obj\*.bin del ..\obj\*.bin
	if exist ..\obj\*.txt del ..\list\*.txt 


CFLAGS = -c -cpu xscale -g -O0 -Otime -W -Ono_inline -I..\inc
...
LFLAGS = -info totals -info unused -map -list ..\list\list.txt -entry Reset_Handler -scatter scatter-ram.scf
