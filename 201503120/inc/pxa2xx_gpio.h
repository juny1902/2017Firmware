...
// Contributors: 
// Date:         04/17/2002
// Description:  This file contains register and bit defines for the PXA255
//               GPIO Subsection
//
...
#define __REG2(x,y)		(*(volatile unsigned int *)((x) + (y)))

#define rGPLR(x)		__REG2(0x40E00000, ((x) & 0x60) >> 3)
#define rGPDR(x)		__REG2(0x40E0000C, ((x) & 0x60) >> 3)
#define rGPSR(x)		__REG2(0x40E00018, ((x) & 0x60) >> 3)
#define rGPCR(x)		__REG2(0x40E00024, ((x) & 0x60) >> 3)
#define rGRER(x)		__REG2(0x40E00030, ((x) & 0x60) >> 3)
#define rGFER(x)		__REG2(0x40E0003C, ((x) & 0x60) >> 3)
#define rGEDR(x)		__REG2(0x40E00048, ((x) & 0x60) >> 3)
#define rGAFR(x)		__REG2(0x40E00054, ((x) & 0x70) >> 2)
//	bhji : end
...
#define GPIO_GAFR2U    	0x68    	// GPIO<95:80>  alternate function select register 2 Upper 
#define GPIO_GAFR3L    	0x6C    	// GPIO<111:96> alternate function select register 3 Lower 
#define GPIO_GAFR3U    	0x70    	// GPIO<120:112>alternate function select register 3 Upper 
...
#define GPIO_47_AF_IR_TXD			AF2 << 30	// Set GPDR1, BIT GPIO_47 = 1
#define GPIO_47_AF_STD_TXD			AF1 << 30	// Set GPDR1, BIT GPIO_47 = 1
